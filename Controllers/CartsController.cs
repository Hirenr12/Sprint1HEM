...
namespace Sprint1HEM.Controllers
{
    public class CartsController : Controller
    {
        ...
        public CartsController(RacersContext context)
        {
            _context = context;
        }
        ...
        {
            var racersContext = _context.Carts.Include(c => c.Customer).Include(c => c.Item);
        ...
        public async Task<IActionResult> Create([Bind("CartId,ItemId,CustomerId,Price")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CartId,ItemId,CustomerId,Price")] Cart cart)
        {
            if (id != cart.CartId)
            {
                return NotFound();
